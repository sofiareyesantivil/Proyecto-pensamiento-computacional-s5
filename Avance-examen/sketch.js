...
// Posibles estados: "PORTADA", "MESA", "TRANSICION", "MENU", "CINE", "FIN"
...
// --- AUDIO ---
let festin; // 🔥 Variable para la canción
...
// Memoria para saber qué botones ya se presionaron
...
function resetAnimacion() {
  ...
  // 🔥 Detenemos la música si el botón reiniciar la activa
...
// =========================================================
//            🔥 EFECTO VISUAL (SINESTESIA RATATOUILLE)
// =========================================================
...
function keyPressed() {
  if (key === " " && estadoActual === "PORTADA") {
    ...
    // 🔥 Reproducir canción al arrancar (le pusimos .loop() para que se repita si acaba)
    if (festin && !festin.isPlaying()) {
      festin.loop();
    }
  }
